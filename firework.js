...
const drawGun = () => {
    position.wandX = (width * .91) - image.width;
    position.wandY = (height * .93) - image.height;

    const rotationInRadians = Math.atan2(positions.mouseY - position.wandY, positions.mouseX - position.wandX) - Math.PI;
